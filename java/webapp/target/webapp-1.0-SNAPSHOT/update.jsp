...
<form action="update" method="post">
  ...
  <input type="text" id="name" name="title" value="<%= order.getUsername() %>" required><br>
  <label for="status">New adress:</label>
  <input type="text" id="status" name="adress" value="<%= order.getAdress() %>" required><br>
  <label for="description">New phone:</label><br>
  <input id="description" name="phone" value=" <%= order.getPhone_Number() %>" required><br>
